...
import {
  S1FoggyRoad, S2GroundCool, S3Droplet, S4Float, S5Fog, S6Compare, S7Clear,
} from './scenes';
...
/** s1(캐릭터가 직접 대사를 말하는 유일한 구간)만 mouth.json을 쓴다. s2~s7은 3인칭 설명
 *  내레이션이 다이어그램 위에 흐르는 구간이라 캐릭터가 등장하지 않는다. */
...
export const Episode: React.FC<EpisodeProps> = ({ locale }) => {
  ...
  const scenes: SceneSpec[] = [
    {
      Component: S1FoggyRoad as unknown as SceneSpec['Component'], frames: frames[0],
      props: { frames: frames[0], lines: linesS1, mouth },
    },
    {
      Component: S2GroundCool as unknown as SceneSpec['Component'], frames: frames[1],
    ...
    {
      Component: S4Float as unknown as SceneSpec['Component'], frames: frames[3],
      props: { frames: frames[3], lines: linesS4 },
    },
    {
      Component: S5Fog as unknown as SceneSpec['Component'], frames: frames[4],
    ...
    {
      Component: S7Clear as unknown as SceneSpec['Component'], frames: frames[6],
