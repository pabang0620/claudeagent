...
import {
  S1Compare, S2Graph, S3Rise, S4Seal, S5Overboil, S6Altitude, S7Bowl,
} from './scenes';
...
export const Episode: React.FC<EpisodeProps> = ({ locale }) => {
  ...
  const scenes: SceneSpec[] = [
    ...
    {
      Component: S2Graph as unknown as SceneSpec['Component'], frames: frames[1],
      props: { frames: frames[1], lines: linesS2 },
    },
    {
      Component: S3Rise as unknown as SceneSpec['Component'], frames: frames[2],
    ...
    {
      Component: S5Overboil as unknown as SceneSpec['Component'], frames: frames[4],
      props: { frames: frames[4], lines: linesS5 },
    },
    {
      Component: S6Altitude as unknown as SceneSpec['Component'], frames: frames[5],
      props: { frames: frames[5], lines: linesS6 },
    },
    {
      Component: S7Bowl as unknown as SceneSpec['Component'], frames: frames[6],
