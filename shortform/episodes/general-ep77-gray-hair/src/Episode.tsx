/** 본편 조립. Intro + TitleCard + 7개 장면(s1만 BustActor 립싱크 있음, s2~s7은 무성
 *  다이어그램/소품 - 3인칭 설명 내레이션이라 립싱크 연결 없음) + Outro.
...
import {
  S1Hook, S2Follicle, S3Graph, S4Compare, S5Reflect, S6Myth, S7Summary,
} from './scenes';
import { Locale, STRINGS } from './strings';

interface WordsFile { segments: SegmentData[] }
interface MouthFile { mouth: Record<string, number[]> }
...
export const Episode: React.FC<EpisodeProps> = ({ locale }) => {
  ...
  const scenes: SceneSpec[] = [
    ...
    {
      Component: S2Follicle as unknown as SceneSpec['Component'], frames: frames[1],
      props: { frames: frames[1], lines: linesS2 },
    },
    {
      Component: S3Graph as unknown as SceneSpec['Component'], frames: frames[2],
    ...
    {
      Component: S5Reflect as unknown as SceneSpec['Component'], frames: frames[4],
