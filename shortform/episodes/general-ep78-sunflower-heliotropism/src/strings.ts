/** 이 화(general-ep78, "해바라기가 해를 따라 도는 이유") 전용 화면 문구. 언어별
...
export const STRINGS = {
  ko: {
    title: '해바라기가 해를 따라 도는 이유',
    youngLabel: '어린 해바라기',
    matureLabel: '다 자란 해바라기',
    dayLabel: '낮',
    nightLabel: '밤',
    stoppedLabel: '더는 안 움직임',
    fixedEastLabel: '동쪽으로 고정',
    warmerLabel: '아침 햇살을 먼저 받아요',
    outroNextTitle: '다음 편',
