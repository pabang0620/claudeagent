/** 본편 조립. Intro + TitleCard + 7개 장면(전부 유성 내레이션, s1·s6만 립싱크) + Outro.
...
import {
  S1Nervous, S2Density, S3TypeHighlight, S4BodyCompare, S5Ancestor, S6Crossfade, S7Polygraph,
} from './scenes';
...
/** s1·s6(캐릭터가 화면에 등장하는 구간)만 mouth.json을 쓴다. s2~s5·s7은 다이어그램만
...
export const Episode: React.FC<EpisodeProps> = ({ locale }) => {
  ...
  const scenes: SceneSpec[] = [
    {
      Component: S1Nervous as unknown as SceneSpec['Component'], frames: frames[0],
      props: { lines: linesS1, mouth },
    },
    {
      Component: S2Density as unknown as SceneSpec['Component'], frames: frames[1],
      props: { frames: frames[1], lines: linesS2 },
    },
    {
      Component: S3TypeHighlight as unknown as SceneSpec['Component'], frames: frames[2],
      props: { frames: frames[2], lines: linesS3 },
    },
    {
      Component: S4BodyCompare as unknown as SceneSpec['Component'], frames: frames[3],
      props: { frames: frames[3], lines: linesS4 },
    },
    {
      Component: S5Ancestor as unknown as SceneSpec['Component'], frames: frames[4],
      props: { frames: frames[4], lines: linesS5 },
    },
    {
      Component: S6Crossfade as unknown as SceneSpec['Component'], frames: frames[5],
      props: { frames: frames[5], lines: linesS6, mouth },
    },
    {
      Component: S7Polygraph as unknown as SceneSpec['Component'], frames: frames[6],
